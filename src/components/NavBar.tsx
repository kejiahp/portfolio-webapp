...
const NavBar = () => {
  return (
    <div className="flex md:justify-between py-5 px-12 lg:px-24 md:flex-row flex-col justify-center items-center pb-24 md:pb-8 2xl:container 2xl:mx-auto z-40 relative">
