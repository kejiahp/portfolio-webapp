      ...
      <div className="px-12 lg:px-24 mt-20 2xl:container 2xl:mx-auto">
        <section className="relative py-1 pt-10 md:py-24" data-aos="zoom-in">
          ...
          <div className="flex justify-center items-center flex-col md:block text-center md:text-left md:mt-0 mt-96">
            <section className="">
              <p className="text-custBlack-400 font-bold md:text-7xl text-5xl">
                Nice to meet you!
              </p>
              <p className="text-custBlack-400 font-bold md:text-7xl text-5xl">
                I’m{" "}
                <span className="after:h-1 after:bg-custGreen after:block  after:bottom-0 after:left-0 after:w-full after:absolute relative">
                  Popoola Morenikeji
                </span>
                .
              </p>
